...
class GridMask(Measurement):
    def __init__(self, 
        ...
        # make mask
        mask = torch.zeros((grid_size, grid_size), device=self.device)
    ...
    def Sigma_root_apply(self, x, s, t):
        Sigma_s_t = self.Sigma(s, t)
        return torch.sqrt(torch.abs(Sigma_s_t)) * x 
    ...
    def guidance(self, z_norm, x_norm, t):
        ...
        residual = z_norm - M_t_1 * x_norm - self.U(t, t1)
